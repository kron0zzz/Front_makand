    ...
    <div className="page-container">
      <div className="header-container">
        ...
        <div className="header-actions">
          ...
          {hasPermission('Crear Categoría de Maquinaria') && (
            <button 
              className="btn-nuevo"
              onClick={() => {
                setIsEditing(false);
              ...
              categories.map((cat) => (
                <tr key={cat.category_id}>
                  ...
                  <td className="actions-cell">
                    {hasPermission('Editar Categoría de Maquinaria') && (
                      <button className="action-btn edit" title="Editar" onClick={() => prepararEdicion(cat)}>
                        <Edit size={18} />
                      </button>
                    )}
                    {hasPermission('Eliminar Categoría de Maquinaria') && (
