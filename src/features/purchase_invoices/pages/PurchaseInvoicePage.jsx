...
//       const maquinaria = i.machinery_name?.toLowerCase() || '';
//       const proveedor = i.supplier_name?.toLowerCase() || '';
      
//       return id.includes(termino) || maquinaria.includes(termino) || proveedor.includes(termino);
//     });
//   }, [invoices, busqueda]);
...
//       machinery_name: invoice.machinery_name,
...
//           <p>Control y soporte de compras de maquinaria - Makand</p>
//         </div>
...
const PurchaseInvoicePage = () => {
  ...
  const facturasFiltradas = useMemo(() => {
    ...
    return datos.filter(i => {
      const id = i.invoice_id?.toString() || '';
      const machinery = i.machinery_name?.toLowerCase() || '';
