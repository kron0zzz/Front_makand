// // // src/features/sub_rental/components/SubRentalForm/SubRentalForm.jsx
// // import { useState, useEffect } from 'react';
// // import { subRentalService } from '../../services/subRentalService';
// // // import './SubRentalForm.css';
...
// //   // Cargar catálogos auxiliares (Maquinarias y Proveedores) usando el token limpio
// //   useEffect(() => {
...
// //         if (resMachines.ok) setMachines(await resMachines.json());
...
// //     // Convertir a tipo de dato numérico o booleano si aplica
...
// //       // 🛠️ Ejecuta la recarga automática en el componente padre si el callback existe
// //       if (onSuccess) {
// //         await onSuccess();
// //       }
...
// //     } catch (err) {
// //       console.error(err);
// //       setError(err.response?.data?.error || 'Error al procesar el subalquiler.');
// //     } finally {
// //       setCargando(false);
// //     }
// //   };
...
//   // Cargar catálogos auxiliares usando el token limpio
//   useEffect(() => {
//     const cargarCatalogos = async () => {
//       try {
//         const token = localStorage.getItem('token')?.replace(/^"|"$/g, '');
...
//                 <option value="">Seleccione la maquinaria...</option>
//                 {machines.map((m) => (
//                   <option key={m.machinery_id} value={Number(m.machinery_id)}>
//                     {m.machinery_name} {m.machinery_model ? `(${m.machinery_model})` : ''}
//                   </option>
//                 ))}
//               </select>
...
//                 <option value="">Seleccione el proveedor...</option>
//                 {suppliers.map((sup) => (
//                   <option key={sup.supplier_id} value={Number(sup.supplier_id)}>
//                     {sup.supplier_name}
//                   </option>
//                 ))}
//               </select>
